...
def _rebuild_duration_model():
    """Refits the duration model from the persistent session cache.

    Cheap enough to run once per backfill: one pass over the cached sessions
    and two sums.
    """
